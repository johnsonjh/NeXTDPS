...
_NOTICE RCSID[]="$Header: psrev.c,v 2.2 87/11/17 16:52:16 byron Rel $";
#endif
/* psrev.c
 *
 ...
 * RCSLOG:
 * $Log:	psrev.c,v $
 * Revision 2.2  87/11/17  16:52:16  byron
 * Release 2.1
 * 
 * Revision 2.1.1.2  87/11/12  13:41:53  byron
 * Changed Government user's notice.
 * 
 * Revision 2.1.1.1  87/04/23  10:26:41  byron
 * Copyright notice.
 * 
 * Revision 2.2  86/11/02  13:57:36  shore
 * Product Update
 * 
