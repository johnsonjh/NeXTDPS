...
static char	padchar;	/* pad character for output */
...
static char    *resolution = 0;        /* printer resolution */
static char    manualfeed = 0;         /* manual feed flag */
...
#ifdef NeXT_MOD
	if (printer == NULL
	   && (printer = (char *)NXGetDefaultValue("System", "Printer")) ==
	    NULL
