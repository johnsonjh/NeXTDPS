...
Jim Sandman: Wed May 31 16:53:42 1989
Joe Pasqua: Tue Feb 28 11:38:52 1989
End Edit History.
*/

#define SMASK scanmask
#define SSHIFT scanshift
#define SUNIT scanunit
#define LOG2BPP log2BPP

#define PROCNAME ImS11D1X

#define DECLAREVARS \
  integer scanmask, scanshift, scanunit, log2BPP;
